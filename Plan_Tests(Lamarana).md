...
- Si la case visée est de l’eau (`"~~"`), c’est un tir raté :  
  → on met le symbol `"}{"` dans les deux grilles  
...
|------:|--------------------------|--------------------------------------------------|------------------------------------|-------------------------------------|----------------------------------------|---------------------------|------------------------------------------------------------------------------|
| 1     | Tir dans l’eau          | `"~~"`                                           | ligne = 1, colonne = 1            | `grille_tirs[1][1] == '}{'`         | `grille_bateaux[1][1] == '}{'`         | contient `"TIR MANQUÉ"`  | `assert grille_tirs[1][1] == '}{'` ; `assert grille_bateaux[1][1] == '}{'` ; |
